...
// Called every frame
void AGridFill::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void AGridFill::MakeBox(FVector3f dimensions)
{
	...
	// Generate verts
	FVector BoxVerts[8];
	BoxVerts[0] = FVector(-dimensions.X, dimensions.Y, dimensions.Z);
	BoxVerts[1] = FVector(dimensions.X, dimensions.Y, dimensions.Z);
	BoxVerts[2] = FVector(dimensions.X, -dimensions.Y, dimensions.Z);
	BoxVerts[3] = FVector(-dimensions.X, -dimensions.Y, dimensions.Z);

	BoxVerts[4] = FVector(-dimensions.X, dimensions.Y, -dimensions.Z);
	BoxVerts[5] = FVector(dimensions.X, dimensions.Y, -dimensions.Z);
	BoxVerts[6] = FVector(dimensions.X, -dimensions.Y, -dimensions.Z);
	BoxVerts[7] = FVector(-dimensions.X, -dimensions.Y, -dimensions.Z);
	...
	ProceduralMesh->CreateMeshSection(0, Vertices, Triangles, Normals, UVs, UVs, UVs, UVs, Colors, Tangents, true);
}

void AGridFill::MakeInvertedBox(FVector3f dimensions)
{
